        ...
        <div className="min-h-screen bg-gray-100 flex flex-col">
            ...
            {loading === "bagisto" && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex flex-col items-center justify-center text-white z-50 p-6 text-center">
                    ...
                    <h3 className="text-3xl font-black mb-2 uppercase tracking-tighter text-red-500">Suppression API en cours</h3>
        ...
        <div className={`bg-white rounded-[2.5rem] p-8 shadow-sm border ${color === 'red' ? 'border-red-200' : 'border-gray-100'} flex flex-col items-center text-center`}>
            ...
            <button
                ...
                className={`w-full py-4 rounded-xl font-bold text-white transition-all active:scale-95 flex items-center justify-center gap-2 ${
                    loading ? "bg-gray-200 text-gray-500" : (success ? "bg-green-500" : btnClasses[color])
                }`}
            >
                {loading ? (
